...
export const iconMap = {
  ...
  Xoutlined: () => import("./Xoutlined").then((mod) => mod.Xoutlined),
  Instagramoutlined: () => import("./Instagramoutlined").then((mod) => mod.Instagramoutlined),
  ProgressTrackingoutlined: () => import("./ProgressTrackingoutlined").then((mod) => mod.ProgressTrackingoutlined),
  InteractiveVideoContentoutlined: () =>
    import("./InteractiveVideoContentoutlined").then((mod) => mod.InteractiveVideoContentoutlined),
  Beginneroutlined: () => import("./Beginneroutlined").then((mod) => mod.Beginneroutlined),
  Facebookoutlined: () => import("./Facebookoutlined").then((mod) => mod.Facebookoutlined),
  CertificatesAndBadgesoutlined: () =>
    import("./CertificatesAndBadgesoutlined").then((mod) => mod.CertificatesAndBadgesoutlined),
  ...
  ExpertMentorshipoutlined: () => import("./ExpertMentorshipoutlined").then((mod) => mod.ExpertMentorshipoutlined),
  Menuoutlined: () => import("./Menuoutlined").then((mod) => mod.Menuoutlined),
  Expertoutlined: () => import("./Expertoutlined").then((mod) => mod.Expertoutlined),
};
